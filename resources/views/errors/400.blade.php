...
@section('title', 'Bad Request - TSEA')
@section('description', 'The request could not be understood')
...
<section class="error-page">
    <div class="container">
        <div class="error-content">
            ...
            <h1>Bad Request</h1>
            <p class="error-message">The request could not be understood by the server.</p>
